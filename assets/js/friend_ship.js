{
    ...
    let convertPostsToAjax = function () {
        $("#user-friends>p>a").each(function (item) {
            let self = $(this);
            console.log(self);
            // let postId = self.prop("id").split(" ")[0];
    ...
    function newUserDetail(userDetail) {
        // console.log(" call inside newCommentDom ")

        // I've added a class 'delete-comment-button' to the delete comment link and also id to the comment's li
        return $(`<li id="comment-${userDetail._id}">
                        <p>
                            <small>
